...
public class Client {
	...
	public Customer customerLogin(String email, String password) {
		...
		try {
			...
			if (c != null)
				System.out
						.println("[response] customer " + c.getFirstName() + " " + c.getLastName() + " login Succeed");
			else
	...
	public Customer addNewCustomer(String id, String firstName, String lastName, String password, String type,
		...
		try {
			...
			OutputStreamWriter osw = new OutputStreamWriter(socket.getOutputStream());
			PrintWriter pw = new PrintWriter(osw);
			pw.println("add client " + id + " " + firstName + " " + lastName + " " + password + " " + type + " " + email
					+ " " + phone);
			pw.flush();
